                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($roles as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/roles/' . $item->id . '/edit') }}" title="Editar Productos"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
