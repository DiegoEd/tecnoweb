            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/suppliers/index/indexdelete', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ url('/suppliers/'. $item->id) }}" style="display:inline">
                                                ...
                                                {!! csrf_field() !!}
                                                <button type="submit" class="btn btn-danger btn-xs" title="Delete Proveedor" onclick="return confirm('Confirm delete?')"><i class="fa fa-trash-o" aria-hidden="true"></i> Eliminar</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
