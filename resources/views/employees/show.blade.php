                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $employees->name }} </td></tr><tr><th> Lastname </th><td> {{ $employees->lastname }} </td></tr><tr><th> Sexo </th><td> {{ $employees->sex }} </td></tr><tr><th> Edad </th><td> {{ $employees->age }} </td></tr><tr><th> Carrera </th><td> {{ $employees->career }} </td></tr><tr><th> Nombre de Usuario </th><td> {{ $employees->username }} </td></tr><tr><th> Contraseña </th><td> {{ $employees->password }} </td></tr><tr><th> Correo </th><td> {{ $employees->email }} </td></tr>
                                </tbody>
                            </table>
                        </div>
